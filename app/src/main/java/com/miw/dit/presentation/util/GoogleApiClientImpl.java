package com.miw.dit.presentation.util;
 ...
 */
public class GoogleApiClientImpl implements
    ...
    private GoogleApiClientCallback callback;

    private boolean intentInProgress;

    public GoogleApiClientImpl(Activity activity, GoogleApiClientCallback callback) {
